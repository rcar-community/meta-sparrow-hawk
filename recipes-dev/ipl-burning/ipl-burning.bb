...
do_deploy() {
    ...
    install -m 755 ${WORKDIR}/rcar_gen4_pcie.bin* ${DEPLOYDIR}/${PN}/rcar_gen4_pcie.bin
    install -m 755 ${WORKDIR}/LICENCE.r8a779g_pcie_phy* ${DEPLOYDIR}/${PN}/License/LICENCE.r8a779g_pcie_phy
